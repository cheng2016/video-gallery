...
>
> 该项目使用ai生成，验证ai的可行性、功能性、可迭代性，事实证明当项目大到一定程度，ai开始出现很多幻觉，具体的bug和逻辑非常容易混乱，后期成本远超个人开发，经常迭代一个功能使得整个系统都发生问题，还是需要用人的思想来管理ai，如增加日志，让ai通过日志证据修改bug等等，所以一切人开发中所需要的流程ai都需要掌握和使用，不然ai就是个偏科的空架子，无法进行大型项目开发。该结论烧掉珍贵的数亿乃至数十亿token换来，望后来者谨记。
